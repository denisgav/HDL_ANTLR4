...
{
    public partial class SignalDeclarationTemplate
    {
        ...
        public SignalDeclarationTemplate(string typeName, string name, params object[] constructorParameters)
        {
        ...
        public SignalDeclarationTemplate(string typeName, string name, object constructorParameter)
            : this(typeName, name, new object[] { constructorParameter })
        { }

        public SignalDeclarationTemplate(string typeName, string name)
