...
{
    public partial class FloatPointTypeTemplate
    {
        ...
        public FloatPointTypeTemplate(string name, Double rangeLeft, Double rangeRight, RangeDirection rangeDirection)
            : this("Work", name, rangeLeft, rangeRight, rangeDirection)
        {
        }
    }
}
