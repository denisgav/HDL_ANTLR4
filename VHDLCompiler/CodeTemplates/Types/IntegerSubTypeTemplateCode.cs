...
{
    public partial class IntegerSubTypeTemplate
    {
        ...
        public IntegerSubTypeTemplate(string nameSpaceName, string name, string baseTypeName, Int64 rangeLeft, Int64 rangeRight, RangeDirection rangeDirection)
        {
        ...
        public IntegerSubTypeTemplate(string name, string baseTypeName, Int64 rangeLeft, Int64 rangeRight, RangeDirection rangeDirection)
