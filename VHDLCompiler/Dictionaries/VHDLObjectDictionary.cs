...
{
    public class VHDLObjectDictionary
    {
        private Dictionary<VhdlObject, string> intenalDictionary;

        public VHDLObjectDictionary()
        {
            intenalDictionary = new Dictionary<VhdlObject, string>(); 
        }
