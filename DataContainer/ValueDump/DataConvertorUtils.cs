...
namespace DataContainer.ValueDump
{
    ...
    public abstract class DataConvertorUtils
    {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool[] ToBitArray(long value, int size)
        {
        ...
        /// <summary>
        /// Преобразование в строку STD_ULOGIC_VALUE
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(STD_ULOGIC_VALUE value, DataRepresentation dataRepresentation)
        {
            if (dataRepresentation.IsInverted == false)
            {
            ...
            else
            {
                ...
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_U)
                    return "U";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_X)
                    return "X";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_0)
                    return "1";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_1)
                    return "0";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_Z)
                    return "X";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_W)
                    return "X";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_L)
                    return "1";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_H)
                    return "0";
                if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_DONT_CARE)
                    return "X";
        ...
        /// <summary>
        /// Преобразование в строку BIT_VALUE
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(BIT_VALUE value, DataRepresentation dataRepresentation)
        {
            if (dataRepresentation.IsInverted == false)
            {
                return new string(new char[] { (value.Value as VHDL.type.EnumerationType.CharacterEnumerationLiteral).getLiteral() });
            ...
            {
                if (value.Value == VHDL.builtin.Standard.BIT_0)
                    return "1";
                if (value.Value == VHDL.builtin.Standard.BIT_1)
                    return "0";
                return string.Empty;
            }
        }
        ...
        /// <summary>
        /// Преобразование в строку BOOLEAN_VALUE
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(BOOLEAN_VALUE value, DataRepresentation dataRepresentation)
        {
            if (dataRepresentation.IsInverted == false)
            {
                return new string(new char[] { (value.Value as VHDL.type.EnumerationType.CharacterEnumerationLiteral).getLiteral() });
            ...
            {
                if (value.Value == VHDL.builtin.Standard.BOOLEAN_TRUE)
                    return "FALSE";
                if (value.Value == VHDL.builtin.Standard.BOOLEAN_FALSE)
                    return "TRUE";
                return string.Empty;
            }
        }
        ...
        /// <summary>
        /// Преобразование в строку IntegerValue
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(IntegerValue value, DataRepresentation dataRepresentation)
        {
            int integer_value = value.Value;
            if (dataRepresentation.IsInverted == true)
                integer_value = -integer_value;

            if (dataRepresentation is VectorDataRepresentation)
            {
                switch ((dataRepresentation as VectorDataRepresentation).EnumerationSystem)
                {
                    case EnumerationSystem.Bin:
                        return Convert.ToString(integer_value, 2);
                    case EnumerationSystem.Oct:
                        return Convert.ToString(integer_value, 8);
                    case EnumerationSystem.Dec:
                        return Convert.ToString(integer_value, 10);
                    case EnumerationSystem.Hex:
                        return Convert.ToString(integer_value, 16);
                }
            }
            return integer_value.ToString();
        }

        /// <summary>
        /// Преобразование в строку RealValue
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(RealValue value, DataRepresentation dataRepresentation)
        {
            double doubleValue = value.Value;
            if (dataRepresentation.IsInverted == true)
                doubleValue = -doubleValue;
            return Convert.ToString(doubleValue, System.Globalization.CultureInfo.InvariantCulture);
        }

        /// <summary>
        /// Преобразование в строку EnumerationValue
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(EnumerationValue value, DataRepresentation dataRepresentation)
        {
        ...
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(PhysicalValue value, DataRepresentation dataRepresentation)
        {
            return value.Value.ToString();
        }
        ...
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(RecordValue value, DataRepresentation dataRepresentation)
        {
            StringBuilder res = new StringBuilder();
            res.Append("{ ");
            for (int i = 0; i < value.Values.Count; i++)
            {
                AbstractValue el = value.Values.Values.ElementAt(i);
                if(i < value.Values.Count - 1)
                    res.AppendFormat("{0}, ", ToString(el, el.GetDefaultDataRepresentation()));
                else
                    res.AppendFormat("{0} ", ToString(el, el.GetDefaultDataRepresentation()));
            }
            res.Append(" }");
        ...
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(ArrayValue value, DataRepresentation dataRepresentation)
        {
            StringBuilder res = new StringBuilder();
            res.Append("{ ");
            for (int i = 0; i < value.Values.Count; i++)
        ...
        /// <summary>
        /// Преобразование в строку STD_ULOGIC_VECTOR_VALUE
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(STD_ULOGIC_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            if (dataRepresentation.EnumerationSystem == EnumerationSystem.Bin)
            {
                List<STD_ULOGIC_VALUE> values = new List<STD_ULOGIC_VALUE>();
                foreach (AbstractValue v in value.Values.Values)
                    values.Add(v as STD_ULOGIC_VALUE);
                return ToStringBinaryData(values, dataRepresentation);
            }
            else
                return ToString(ToBoolValue(value), dataRepresentation);
        }
        ...
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(STD_LOGIC_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            if (dataRepresentation.EnumerationSystem == EnumerationSystem.Bin)
            {
                List<STD_ULOGIC_VALUE> values = new List<STD_ULOGIC_VALUE>();
        ...
        private static string ToStringBinaryData(List<STD_ULOGIC_VALUE> values, VectorDataRepresentation dataRepresentation)
        {
            StringBuilder res = new StringBuilder();
            if (dataRepresentation.IsReorderedBits == true)
            {
                values.Reverse();
            }
            ...
            if (dataRepresentation.IsInverted == false)
            {
                foreach (STD_ULOGIC_VALUE v in values)
                    res.Append(v.ToString());
            }
            else
            {
                foreach (STD_ULOGIC_VALUE v in values)
                    res.Append(STD_ULOGIC_VALUE.NOT(v).ToString());
            }
        ...
        /// <summary>
        /// Преобразование в строку BIT_VECTOR_VALUE
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static string ToString(BIT_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            return ToString(ToBoolValue(value), dataRepresentation);
        }
        ...
        /// <summary>
        /// Преобразование к целочисленному значению STD_ULOGIC_VECTOR_VALUE с учетом представления данных
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static BigInteger? ToBigInteger(STD_ULOGIC_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            return ToBigInteger(ToBoolValue(value), dataRepresentation);
        }
        ...
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static BigInteger? ToBigInteger(STD_LOGIC_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            return ToBigInteger(ToBoolValue(value), dataRepresentation);
        }

        /// <summary>
        /// Преобразование к целочисленному значению BIT_VECTOR_VALUE с учетом представления данных
        /// </summary>
        /// <param name="value"></param>
        /// <param name="dataRepresentation"></param>
        /// <returns></returns>
        public static BigInteger? ToBigInteger(BIT_VECTOR_VALUE value, VectorDataRepresentation dataRepresentation)
        {
            return ToBigInteger(ToBoolValue(value), dataRepresentation);
        }
        ...
        /// <summary>
        /// Функция, которая преобразует значение STD_ULOGIC_VALUE в bool
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool> ToBoolValue(STD_ULOGIC_VALUE value)
        {
            if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_0)
                return false;
            if (value.Value == VHDL.builtin.StdLogic1164.STD_LOGIC_1)
        ...
        /// <summary>
        /// Функция, которая преобразует значение STD_ULOGIC_VECTOR_VALUE в bool[]
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool>[] ToBoolValue(STD_ULOGIC_VECTOR_VALUE value)
        {
            List<Nullable<bool>> res = new List<Nullable<bool>>();
            foreach (var v in value)
            {
                if(v.Value is STD_ULOGIC_VALUE)
                    res.Add(ToBoolValue(v.Value as STD_ULOGIC_VALUE));
                else
                    return null;
            }
            return res.ToArray();
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool>[] ToBoolValue(STD_LOGIC_VECTOR_VALUE value)
        {
            List<Nullable<bool>> res = new List<Nullable<bool>>();
            foreach (var v in value)
            {
        ...
        /// <summary>
        /// Функция, которая преобразует значение BIT_VALUE в bool
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool> ToBoolValue(BIT_VALUE value)
        {
            return (value.Value == VHDL.builtin.Standard.BIT_1);
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool>[] ToBoolValue(BIT_VECTOR_VALUE value)
        {
            List<Nullable<bool>> res = new List<Nullable<bool>>();
            foreach (var v in value)
            {
                if (v.Value is BIT_VALUE)
                    res.Add(ToBoolValue(v.Value as BIT_VALUE));
                else
                    return null;
            }
            return res.ToArray();
        ...
        /// <summary>
        /// Функция, которая преобразует значение BOOLEAN_VALUE в bool
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static Nullable<bool> ToBoolValue(BOOLEAN_VALUE value)
        {
            return (value.Value == VHDL.builtin.Standard.BOOLEAN_TRUE);
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static string ToString(AbstractValue value, DataRepresentation dataRepresentation)
        {
            if (value is STD_ULOGIC_VALUE)
                return ToString(value as STD_ULOGIC_VALUE, dataRepresentation);
            if (value is BIT_VALUE)
                return ToString(value as BIT_VALUE, dataRepresentation);
            if (value is BOOLEAN_VALUE)
                return ToString(value as BOOLEAN_VALUE, dataRepresentation);
            if (value is IntegerValue)
                return ToString(value as IntegerValue, dataRepresentation);
            if (value is RealValue)
                return ToString(value as RealValue, dataRepresentation);
            if (value is STD_LOGIC_VECTOR_VALUE)
                return ToString(value as STD_LOGIC_VECTOR_VALUE, (dataRepresentation as VectorDataRepresentation));
            if (value is STD_ULOGIC_VECTOR_VALUE)
                return ToString(value as STD_ULOGIC_VECTOR_VALUE, (dataRepresentation as VectorDataRepresentation));
            if (value is BIT_VECTOR_VALUE)
                return ToString(value as BIT_VECTOR_VALUE, (dataRepresentation as VectorDataRepresentation));
            if (value is EnumerationValue)
                return ToString(value as EnumerationValue, dataRepresentation);
            if (value is PhysicalValue)
                return ToString(value as PhysicalValue, dataRepresentation);
            if (value is RecordValue)
                return ToString(value as RecordValue, dataRepresentation);
            if (value is ArrayValue)
                return ToString(value as ArrayValue, dataRepresentation);
            return string.Empty;
        }
