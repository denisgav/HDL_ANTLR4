...
namespace HDL_EditorExtension.Editing
{
    ...
    /// 
    /// </summary>
    public class VHDL_WarningColorizer : ColorizingTransformer
    {
        VHDL_Lexter Lexter;

        public VHDL_WarningColorizer(VHDL_Lexter Lexter)
		{
            if (Lexter == null)
		...
		protected override void Colorize(ITextRunConstructionContext context)
		{
            ...
            if (Lexter != null)
            {
                foreach (Exception_Information segment in Lexter.WarningList)
                {
                    ...
                    ChangeVisualElements(
                        ...
                        element =>
                        {
                            ...
                            decor.Pen = new System.Windows.Media.Pen(System.Windows.Media.Brushes.Blue, 3);
                            coll.Add(decor);
