...
namespace VHDL.builtin
{
    ...
    public class StdLogicSigned
    {
        ...
        public static readonly UseClause USE_CLAUSE = new UseClause("ieee.std_logic_signed.all");
        ...
        public static readonly PackageDeclaration PACKAGE = new PackageDeclaration("std_logic_signed");

        static StdLogicSigned()
        {
