...
namespace VHDL.expression
{
    ...
    /// </summary>
    [Serializable]
    public class LessThan : RelationalExpression
    {
        /// <summary>
        ...
        public LessThan(Expression left, Expression right)
            : base(left, ExpressionKind.LESS_THAN, right)
        {
        }

        public override Choice copy()
        {
            return new LessThan(Left.copy() as Expression, Right.copy() as Expression);
        }
    }
