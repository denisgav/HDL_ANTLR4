...
namespace VHDL.expression
{
    ...
    /// </summary>
    [Serializable]
    public class LessEquals : RelationalExpression
    {
        /// <summary>
        ...
        public LessEquals(Expression left, Expression right)
            : base(left, ExpressionKind.LESS_EQUALS, right)
        {
        }

        public override Choice copy()
        {
            return new LessEquals(Left.copy() as Expression, Right.copy() as Expression);
        }
    }
