...
namespace VHDL.expression
{
    ...
    /// </summary>
    [Serializable]
    public abstract class AddingExpression : BinaryExpression
    {
        /// <summary>
        ...
        internal AddingExpression(Expression left, ExpressionKind kind, Expression right)
            : base(left, kind, right, ExpressionPrecedences.ADDING_EXPRESSION)
        {
        }
    }
