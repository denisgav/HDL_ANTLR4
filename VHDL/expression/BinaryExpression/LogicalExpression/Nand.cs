...
namespace VHDL.expression
{
    ...
    /// </summary>
    [Serializable]
	public class Nand : LogicalExpression
	{
        /// <summary>
		...
		public Nand(Expression left, Expression right) : base(left, ExpressionKind.NAND, right)
		{
		}

        public override Choice copy()
		{
            return new Nand(Left.copy() as Expression, Right.copy() as Expression);
		}
	}
