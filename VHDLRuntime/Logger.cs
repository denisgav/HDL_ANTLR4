...
namespace VHDLRuntime
{
    ...
    public class Logger : IDisposable
    {
        ...
        {
            return CreateLogger(folderPath, "sim");
        }
        ...
        public void Write(LoggerMessageVerbosity verbosity, VHDLRuntime.Values.BuiltIn.TIME time, int CurrentDutyCycle, object arg)
        {
        ...
        public void WriteFormat(LoggerMessageVerbosity verbosity, VHDLRuntime.Values.BuiltIn.TIME time, int CurrentDutyCycle, string str, params object[] args)
        {
            string userMessage = string.Format(str, args);
            string message = String.Format("[{0}:{1}][{2}] {3}", time, CurrentDutyCycle, verbosity, userMessage);
            writer.Write(message);
            onWriteEvent(verbosity, message);
        }
        #endregion
