...
namespace My_Editor.Editing
{
    ...
    /// test
    /// </summary>
    public class WarningColorizer : ColorizingTransformer
    {
        TextArea textArea;

        public WarningColorizer(TextArea textArea)
		{
			if (textArea == null)
		...
		protected override void Colorize(ITextRunConstructionContext context)
		{
            ...
            {
                foreach (Exception_Information segment in textArea.Lexter.WarningList)
                {
