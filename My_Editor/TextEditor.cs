...
using My_Editor.Indentation.CSharp;
using My_Editor.Lexter;
using My_Editor.Indentation.Verilog;
...
namespace My_Editor
{
	...
	public class TextEditor : Control, ITextEditorComponent, IServiceProvider, IWeakEventListener
	{
		...
		{
            using (StreamReader reader = FileReader.OpenStream(stream, this.Encoding ?? System.Text.Encoding.GetEncoding("windows-1251")))
            {
		...
		public void Save(Stream stream)
		{
            ...
            StreamWriter writer = new StreamWriter(stream, this.Encoding ?? System.Text.Encoding.GetEncoding("windows-1251"));
