...
namespace My_Editor
{
	...
	public static class AvalonEditCommands
	{
        ...
        /// <summary>
        /// Show CodeCompletitionWindow.
        /// The default shortcut is Ctrl+Space.
        /// </summary>
        public static readonly RoutedCommand ShowCodeCompletitionWindow = new RoutedCommand(
            "ShowCodeCompletitionWindow", typeof(TextEditor),
            new InputGestureCollection {
